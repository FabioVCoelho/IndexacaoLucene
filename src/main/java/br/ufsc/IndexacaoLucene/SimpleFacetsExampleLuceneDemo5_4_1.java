...
public class SimpleFacetsExampleLuceneDemo5_4_1 {
	...
	/** Empty constructor */
	public SimpleFacetsExampleLuceneDemo5_4_1() {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("-----------------------");
		SimpleFacetsExampleLuceneDemo5_4_1 example = new SimpleFacetsExampleLuceneDemo5_4_1();
